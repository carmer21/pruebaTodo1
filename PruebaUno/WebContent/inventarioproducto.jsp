...
<script type="text/javascript" src="./js/inventarioproducto.js"></script>
<title>Inventario por Productos</title>
</head>
<body>
		...
		<div id="contenedorProductos" >
			<form action="" method="POST" id="form_inventarioproducto">
				<table align="center" style="font-weight: bold;" width="98%">
					<tr align="center">
						<td colspan="4" >Administración de Inventario por Productos</td>
					</tr>
					<tr>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>Valor Unidad: </td>
						<td> <input type="text" name="valorUnidad" id="valorUnidad" onkeypress='return soloNumeros(event)' maxlength="15"> </td>
					</tr>
					<tr >
				...
				<p align="center" style="font-weight: bold;">Lista  de Inventario por productos</p>
				<table width="98%" cellspacing="0" class="tablaListas">
					...
					<% InventarioProductoDTO objInventarioProductoDTO;
						for(int i=0; i<listaInventarioProducto.size(); i++){
							...
							<tr>
				    			<td ><%=objInventarioProductoDTO.getIdInventarioProducto()%></td>
				    			...
				    			<td >
				    				<div align="center">
					  	 				<a onclick="eliminarInventario('<%=objInventarioProductoDTO.getIdInventarioProducto()%>','<%=objInventarioProductoDTO.getProductoDTO().getNombre()%>');" style="cursor: pointer;">
					...
					<% ProductosDTO objProductosDTO;
						for(int i=0; i<listaProductos.size(); i++){
							...
							<tr>
								<td >
									<div align="center">
					  	 				<a onclick="seleccionarProducto('<%=objProductosDTO.getIdProducto()%>','<%=objProductosDTO.getTipo()%>','<%=objProductosDTO.getCodigo()%>','<%=objProductosDTO.getNombre()%>');">
